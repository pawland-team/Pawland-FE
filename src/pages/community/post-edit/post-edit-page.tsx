...
import * as S from './post-edit-page-style';
...
export const CommunityPostEditPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Pawland :: 커뮤니티 게시글 수정하기</title>
      </Head>
      <S.PostPage>
        <form onSubmit={handleSubmit(onSubmit)}>
          <S.HeaderArea>
            <S.HeaderTitle>커뮤니티 수정</S.HeaderTitle>
            <S.ButtonArea>
              <S.PostButton type='submit'>
                <S.PostButtonIconWrapper>
                  <Image src='/images/button/add-button.svg' alt='add-button' fill />
                </S.PostButtonIconWrapper>
                <S.buttonTextWrapper>수정하기</S.buttonTextWrapper>
              </S.PostButton>
            </S.ButtonArea>
          </S.HeaderArea>
